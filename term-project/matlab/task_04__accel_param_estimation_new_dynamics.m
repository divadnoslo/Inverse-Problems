...
saveFigureAsEps("MAM_accel_model_parameters.eps", fig)
...
grid on
grid minor
saveFigureAsEps("MAM_accel_model_error.eps", fig)
...
grid on
grid minor
saveFigureAsEps("MAM_accel_model_95_confidence_bounds.eps", fig)