...
grid on
grid minor
saveFigureAsEps(makeFileName(profileNumber, "gyro_singular_values_v2.eps"), fig)
...
b = bar(...
    gyroBiases, ...
    [gyroTable.m_gyro_true(bIndexes).'; ...
...
b = bar(...
    gyroScaleFactors, ...
    [gyroTable.m_gyro_true(sfIndexes).'; ...
...
b = bar(...
    gyroMisalignments, ...
    [gyroTable.m_gyro_true(mIndexes).'; ...
