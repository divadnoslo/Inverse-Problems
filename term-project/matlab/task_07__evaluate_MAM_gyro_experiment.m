%% Task 07: Evaluate Multi-Axis Motion Gyroscope Experiment
...
title("Multi-Axis Motion Test: Gyro Correlation Matrix")
colorbar(ax, "eastoutside")
saveFigureAsEps("MAM_gyro_correlation_matrix.eps", fig)

% Display Gyro Results
disp("Multi-Axis Motion Gyroscope Results")
disp(gyroTable)
